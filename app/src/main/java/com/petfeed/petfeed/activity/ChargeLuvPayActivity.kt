...
import kotlinx.android.synthetic.main.activity_charge_luv_pay.*

class ChargeLuvPayActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        ActivityUtils.statusBarSetting(window, this, R.color.white2, false)
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_charge_luv_pay)
